...
<template>
    <form v-if="props.answer" @submit.prevent="updateAnswer">
        <div class="mb-3">
                ...
                <div class="card-body">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="write" role="tabpanel" aria-labelledby="write-tab"
                             tabindex="0">
                            <textarea rows="7" class="form-control" :class="{ 'is-invalid': form.errors.body }" v-model="form.body"></textarea>
