        ...
        <form @submit.prevent="createQuestion">
            <div class="row mb-3">
                <div class="col-7">
                    ...
                    <input type="text" class="form-control"  v-model="form.title" :class="{ 'is-invalid' : form.errors.title }" name="title" id="question-title">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="write" role="tabpanel"
                                 ...
                                 tabindex="0">
                                <textarea rows="7" class="form-control" :class="{ 'is-invalid' : form.errors.body }" v-model="form.body" name="body">hit there</textarea>
